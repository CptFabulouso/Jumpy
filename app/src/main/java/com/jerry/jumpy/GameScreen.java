...
import com.jerry.jumpy.World.WorldListener;
...
public class GameScreen extends GLScreen {
    ...
    /*
    WorldRenderer takes a reference to the SpriteBatcher as
    a parameter of its constructor. This means that we'll use the same SpriteBatcher to render
    the UI elements of the screen and to render the game world
     */
    ...
    public void update(float deltaTime) {
        ...
        instead of smoothly moving there
         */
        if(deltaTime > 0.1f){
            deltaTime = 0.1f;
        }
    ...
    public void present(float deltaTime) {
        ...
        /*
        We first render the actual game world via the worldRenderer class
         */
        renderer.render();
        ...
        /*
        render all the UI elements on top of the game world depending
        on the current state of the game screen
        */
        switch(state) {
            case GAME_READY:
                presentReady();
