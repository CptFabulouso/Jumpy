...
public class MainMenuScreen extends GLScreen{
    ...
    public MainMenuScreen(Game game) {
        ...
        /*
        guiCam = new Camera2D(glGraphics, 800,1280);
        batcher = new SpriteBatcher(glGraphics,100);
        soundBounds = new Rectangle(0,0,128,128);
        playBounds = new Rectangle(50,900,700,72);
        highscoresBounds = new Rectangle(50,828,700,72);
        helpBounds = new Rectangle(50,756,700,72);
        touchPoint = new Vector2();
        */
    ...
    public void present(float deltaTime) {
        ...
        //we didn't need blending on the background
